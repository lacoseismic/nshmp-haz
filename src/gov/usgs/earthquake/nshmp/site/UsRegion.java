...
public enum UsRegion {
  ...
  VI("U.S. Virgin Islands Charlotte", "Amali"); // TODO Charlotte??
  ...
  /**
   * Returns the {@code UsRegion} for the supplied string, as would be returned by
   * the {@code toString()} method of the target enum value.
   * 
   * @param name to look for
   * @return an {@code Optional} containing the corresponding region, or empty
   *         if there is no matching name.
   */
  public static Optional<UsRegion> fromString(String name) {
